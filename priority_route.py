...
ПСЕВДОКОД АЛГОРИТМА:
1. Получить список банкоматов
2. Для каждого банкомата вызвать get_risk_level()
3. Отсортировать: RED (критичные) → YELLOW (внимание) → GREEN (норма)
4. Построить маршрут жадным алгоритмом (nearest_neighbor_route)
5. Вернуть упорядоченный маршрут
