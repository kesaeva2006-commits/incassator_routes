...
ПСЕВДОКОД АЛГОРИТМА (rebalance_clusters):
1. Для каждого перегруженного кластера:
    а. Обрезать маршрут до 480 минут (trim_route_by_time)
    б. "Лишние" банкоматы собрать в общую очередь
2. Для каждого банкомата из очереди:
    а. Найти кластер с наименьшей загрузкой
    б. Если добавление банкомата не нарушает лимит 480 минут — добавить
    в. Иначе — оставить в очереди на следующий день
3. Перестроить маршруты для всех кластеров
4. Вернуть новые кластеры, маршруты и очередь
"""
